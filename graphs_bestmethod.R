...
graph<-ggplot(dbs) +
  ...
  geom_line(aes(x = x, y = pbeta, color = "Beta"),linewidth=1.5) +
  geom_line(aes(x = x, y = plda2, color = "LDA2"),linewidth=1.5) +
...
tail(sort(psn3_fish),n = 1000)-tail(sort(pslda2_fish),n = 1000)
tail(sort(pslda2_fish),n = 1000)
tail(sort(psbe_fish),n = 1000)
tail(sort(psn5_fish),n = 1000)
tail(sort(rhos_train),n=1000)
